...
<footer style="background-color: #393939;">
	...
	<div class="col-sm-4 hov">
		<img src="logo.png"width="200px"height="50px"/><br><br>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Sector-23,bpccs</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>hotalhub@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+91)9586478913</p><br><br><br>
     <center><img src="logo.png"class="img-responsive"style="width:200px;height:150px;border-radius:100%;"></center>
	</div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Develope By hotelhub@ | All Rights Reserved 2019</p>
</footer>
